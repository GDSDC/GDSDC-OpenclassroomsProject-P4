...
def test_controller_creer_nouveau_tournoi():
    ...
    # Given
    controller_tournoi = controller.Controller(vue=TEST_VUE)
    nouveau_tournoi = TOURNOI

    # When
    controller_tournoi.creer_nouveau_tournoi()
...
def test_controller_terminer_tournoi():
    ...
    raise NotImplementedError("Fill the state correctly")
    controller = Controller(state=initial_state, vue=TEST_VUE)
    ...
    # Then
    assert controller.state == initial_state
